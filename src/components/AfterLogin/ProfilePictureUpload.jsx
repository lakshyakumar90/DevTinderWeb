  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative">
        ...
        {!preview && (
          <div className="absolute -bottom-10 right-5 flex gap-2 justify-center items-center w-20"> 
            {user.profilePicture !== "https://t3.ftcdn.net/jpg/06/33/54/78/360_F_633547842_AugYzexTpMJ9z1YcpTKUBoqBF0CUCk10.jpg" && (
              <button
